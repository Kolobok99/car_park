...
<a name="титульный_лист">Идеи</a> и требования к проекту были позаимствованны из портфолио компании [< SMYT >](https://smyt.ru/). С  "ТЗ" проекта можно ознакомиться по [ссылке](https://smyt.ru/projects/sistema-lk-polzovatelej-avtoparka/) или ниже.
