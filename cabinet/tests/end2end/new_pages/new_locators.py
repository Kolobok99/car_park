...
class AccountPageLocators:
    ...
    FORM_PERSONAL_INPUT_EMAIL = (By.ID, "id_email")
    ...
    TABLE_CARDS_TITLE_ID = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'ID']")
    TABLE_CARDS_TITLE_NUMBER = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Номер']")
    TABLE_CARDS_TITLE_LIMIT = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Лимит']")
    TABLE_CARDS_TITLE_BALANCE = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Остаток']")
    TABLE_CARDS_TITLE_ACTIONS = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Действия']")
    ...
    TABLE_DOCS_TITLE_TYPE = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Тип документа']")
    TABLE_DOCS_TITLE_START_DATE = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Дата получения']")
    TABLE_DOCS_TITLE_END_DATE = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Дата окончания']")
    TABLE_DOCS_TITLE_COPY = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Копия файла']")
    TABLE_DOCS_TITLE_ACTIONS = (By.XPATH, "//*[contains(@class,'apps')]//th[text() = 'Удалить?']")
...
class CarsPageLocators:
    ...
    FORM_CAR_ADD_INPUT_BRAND =(By.ID, "id_brand")
    ...
    FORM_CAR_ADD_BTN_SUBMIT = (By.ID, ".form-car.add.data-show-or-hide-form  button[type='submit']")
    ...
    FILTER_CARS_BRAND_TITLE = (By.XPATH, "//*[contains(@class,'filtr-items__item')]//p[text() = 'Марка']")
    ...
    FILTER_CARS_DRIVERS_CHECKS_1 = (By.CSS_SELECTOR, "input[type='checkbox'][name='driver_has']")
    FILTER_CARS_DRIVERS_CHECKS_0 = ()

    FILTER_CARS_REGIONS_TITLE = (By.XPATH, "//*[contains(@class,'filtr-items__item')]//p[text() = 'Регион']")
    FILTER_CARS_REGIONS_CHECKS = (By.CSS_SELECTOR, "input[type='checkbox'][name='region']")

    FILTER_CARS_APP_TYPE_TITLE = (By.XPATH, "//*[contains(@class,'filtr-items__item')]//p[text() = 'Тип заявки']")
