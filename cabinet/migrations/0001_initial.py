# Generated by Django 4.0.3 on 2022-05-19 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_is', models.BooleanField(default=True, verbose_name='Машина?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('limit', models.PositiveIntegerField(blank=True, verbose_name='Лимит')),
                ('number', models.CharField(blank=True, max_length=16, unique=True, validators=[django.core.validators.MinLengthValidator(16)], verbose_name='Номер')),
                ('balance', models.PositiveIntegerField(blank=True, default=None, null=True, verbose_name='Остаток')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_apps', to=settings.AUTH_USER_MODEL, verbose_name='Владелец')),
