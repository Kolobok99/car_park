...
from api.api import CarAPIViewSet, DriverAPIViewSet, AutoDocsAPIViewSet, DriverDocsAPIViewSet, CardsAPIViewSet, \
...
router.register(r'drivers', DriverAPIViewSet)
router.register(r'car_docs', AutoDocsAPIViewSet, basename='car-docs')
router.register(r'driver_docs', DriverDocsAPIViewSet, basename='driver-docs')
router.register(r'cards', CardsAPIViewSet)
router.register(r'apps', ApplicationsPIViewSet)
router.register(r'history', HistoryAPIViewSet, basename='history')
